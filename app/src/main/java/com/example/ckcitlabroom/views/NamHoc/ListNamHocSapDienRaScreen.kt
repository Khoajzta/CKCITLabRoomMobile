...
fun ListNamHocSapDienRaScreen(
    ...
    var danhsachnamhocsapdienra = danhSachAllNamHoc.filter { it.TrangThai == 2 }
    ...
    Column(
        ...
        LazyColumn(
            ...
            if (danhsachnamhocsapdienra == null || danhsachnamhocsapdienra.isEmpty()) {
                item {
                    Row(
                ...
                items(danhsachnamhocsapdienra) { namhoc ->
